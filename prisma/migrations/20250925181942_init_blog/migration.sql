...
-- CreateIndex
CREATE INDEX "Publicacion_categoria_idx" ON "landing"."Publicacion"("categoria");

-- CreateIndex
CREATE INDEX "Publicacion_publicadoEn_estado_idx" ON "landing"."Publicacion"("publicadoEn", "estado");
